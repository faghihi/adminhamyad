...
Route::group(['middleware' => ['web', 'admin.user']], function () {
    ...
    Route::delete('menu/delete_menu_item/{id}',
        ['uses' => 'VoyagerMenuController@delete_menu', 'as' => 'voyager.menu.delete_menu_item']);
    ...
    Route::get('settings/move_up/{id}',
        ['uses' => 'VoyagerSettingsController@move_up', 'as' => 'voyager.settings.move_up']);
    ...
    Route::post('database/edit-{table}-table', 'VoyagerDatabaseController@update');
    ...
    Route::post('database/store_bread',
        ['uses' => 'VoyagerDatabaseController@storeBread', 'as' => 'voyager.database.store_bread']);
    Route::get('database/{id}/edit-bread',
        ['uses' => 'VoyagerDatabaseController@addEditBread', 'as' => 'voyager.database.edit_bread']);
